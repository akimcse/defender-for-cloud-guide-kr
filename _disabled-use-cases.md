[🏠 전체 목차](./README.md)　·　**Part 3 · 실습·활용**　·　페이지 7 / 7

# 06 · 실무 활용 — 3대 축별 데모 시나리오
...
- **비용 질문 대비**: 무료 기본 CSPM과 유료 플랜의 경계, 30일 체험, 리소스 단위 과금을 미리 정리(→ [01 · 사전 준비](./01-prerequisites.md)).
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [05 · 핸즈온 랩](./05-handson-lab.md) | [🏠 전체 목차](./README.md) |
