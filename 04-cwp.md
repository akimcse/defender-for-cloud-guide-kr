[🏠 전체 목차](./README.md)　·　**Part 2 · 핵심 기능**　·　페이지 5 / 8
...
**5개 핵심 도메인**
1. **보안 태세 관리** — 에이전트리스 K8s 탐색, 컨트롤 플레인 강화, **Azure Policy for Kubernetes**(허용 전 검증·위반 차단), 보안 탐색기 헌팅
...
| ◀ 이전 | ▶ 다음 |
| :-- | --: |
| [03 · CSPM](./03-cspm.md) | [05 · DevSecOps](./05-devsecops.md) |
